...
HRMAll_Diag3<-SymptomsExtraction(HRMAll_Diag2,'IndicANDHx')
# AND
HRMAll_Diag4<-HRMDiagnoses(HRMAll_Diag3)
# 
...
######################################### Data merging######################################### 
#MyImpedanceDataWithHRM(ImpedanceDataSet,dataHRM)
