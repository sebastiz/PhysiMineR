...
#Hash the hospital numbers
#BravoAndHRMNoMissing$HospNum_Id<-unlist(lapply(BravoAndHRMNoMissing$HospNum_Id, function(x) digest(x,algo="sha1")))

library(psych)
#Only select the numerical variables

#2.Recoding
BravoAndHRMNoMissing$AcidRefluxBRAVO<-gsub("NoAcid",0,BravoAndHRMNoMissing$AcidRefluxBRAVO)
BravoAndHRMNoMissing$AcidRefluxBRAVO<-gsub(".*Acid",1,BravoAndHRMNoMissing$AcidRefluxBRAVO)
BravoAndHRMNoMissing$Hiatalhernia<-ifelse(BravoAndHRMNoMissing$Hiatalhernia=="Yes",1,0)
BravoAndHRMNoMissing$AcidRefluxBRAVO<-as.numeric(BravoAndHRMNoMissing$AcidRefluxBRAVO)
