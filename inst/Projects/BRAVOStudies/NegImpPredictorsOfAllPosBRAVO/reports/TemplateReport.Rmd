...
Univariate analysis highlighted `r paste0(Hmisc::label(chosen[2]),collapse=" ,")`, `r paste0(Hmisc::label(chosen[3]),collapse=" ,")`,`r paste0(Hmisc::label(chosen[4]),collapse=" ,")` and `r paste0(Hmisc::label(chosen[5]),collapse=" ,")`  for further investigation with a multivariate analysis
