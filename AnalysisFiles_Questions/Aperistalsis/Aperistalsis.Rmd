---
title: "Patients with chronic cough are unlikely to have any motility abnormalities on HRM"
author: "Zeki SS"
date: "04/09/2018"
...
The investigation of chronic cough poses a significant investigation and healthcare burden in terms of both time and finances. It is estimated that the investigation of chronic cough takes five times longer than that of GERD. In addition, the approach to diagnosis is often based on a rule-out algorithm which is inherently more costly. Omitting low-yield investigations may be beneficial for the patient. The aim of the study is to assess which motility abnormalities are found in patients whose predominant symptom is chronic cough without evidence of dysphagia, regurgitation, heartburn or epigastric pain
...
Define the inclusion set for the subgroup and the exclusion criteria.
