...
# 
# 
Impedance3<-dataImpClean(Impedance2)
ImpSymp2<-dataImpSympClean(ImpSymp)
...
Impedance4<-AcidSubtypes(Impedance3)
...
MyImpedanceDataMerged<-merge(Impedance3,ImpSymp2,by=c("HospNum_Id"),all=TRUE)
