...
**eg** Methicillin-resistant Staphylococcus pseudintermedius (MRSP) has emerged as a highly drug-resistant small animal veterinary pathogen.
...
dataImpSypmAndImpedanceMain<-dataImpClean(dataImpSypmAndImpedanceMain)
dataImpSypmAndImpedanceMain<-dataImpSympClean(dataImpSypmAndImpedanceMain)

#Get the whole BRAVO dataset:
# Need to get the BRAVO data merged from the two tables
AllBravo<-merge(BRAVODay1And2,BRAVOTotal,by="BravoID")
...
dataImpSypmAndImpedanceMain<-dataImpSymptoms(dataImpSypmAndImpedanceMain) 


#Extract who has reflux based on Demeester or on the Number of refluxes from both Impedance and BRAVO
dataImpSypmAndImpedanceMain<-GORDAcidImp(dataImpSypmAndImpedanceMain) 
...
#Get the patients who have had both the BRAVO and impedance study
intersect(BRAVODay1And2$HospNum_Id, Impedance2$HospNum_Id)
