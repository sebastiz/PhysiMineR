...
#Merge the Diag (by Hospital number- a lot of the reports are extracted with NHS Number but these are duplicated- the report with the hospital number should also be in the dataframe so OK to merge on this)
...
#For linking with the Diag to get the clinical details
